...
- Both sidebars include **Claim Slip Branding**. Upload a PNG/JPG school logo (2 MB maximum, 3000 × 3000 maximum), preview it, replace it, or remove it. The file stays on private storage and is embedded into newly generated claim-slip PDFs and their existing ready-notification attachments. Previously issued PDFs and sent emails do not change.
